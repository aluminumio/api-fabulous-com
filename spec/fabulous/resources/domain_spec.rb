...
RSpec.describe Fabulous::Resources::Domain do
  ...
  describe "#list" do
    ...
    context "without pagination" do
      it "returns all domains" do
        stub_request(:get, "#{api_url}/listDomains")
          .with(query: hash_including("username" => "test_user", "password" => "test_pass", "page" => "1"))
    ...
    context "with pagination" do
      ...
      it "fetches all pages automatically" do
        ...
        stub_request(:get, "#{api_url}/listDomains")
          .with(query: hash_including("username" => "test_user", "password" => "test_pass", "page" => "2"))
  ...
  describe "#check" do
    it "returns true when domain is available" do
      stub_request(:get, "#{api_url}/checkDomain")
    ...
    it "returns false when domain is not available" do
      stub_request(:get, "#{api_url}/checkDomain")
        .with(query: hash_including("username" => "test_user", "password" => "test_pass", "domain" => "taken.com"))
  ...
  describe "#info" do
    ...
    it "returns domain information" do
      stub_request(:get, "#{api_url}/domainInfo")
        .with(query: hash_including("username" => "test_user", "password" => "test_pass", "domain" => "example.com"))
  ...
  describe "#set_nameservers" do
    it "updates nameservers successfully" do
      stub_request(:get, "#{api_url}/setNameServers")
        .with(query: hash_including("username" => "test_user", "password" => "test_pass", "domain" => "example.com",
                                    "ns1" => "ns1.new.com", "ns2" => "ns2.new.com", "ns3" => "ns3.new.com"))
        .to_return(body: xml_response(200, "Success"))
  ...
  describe "#lock" do
    it "locks a domain" do
      stub_request(:get, "#{api_url}/lockDomain")
        .with(query: hash_including("username" => "test_user", "password" => "test_pass", "domain" => "example.com"))
        .to_return(body: xml_response(200, "Success"))
  ...
  describe "#unlock" do
    it "unlocks a domain" do
      stub_request(:get, "#{api_url}/unlockDomain")
        .with(query: hash_including("username" => "test_user", "password" => "test_pass", "domain" => "example.com"))
        .to_return(body: xml_response(200, "Success"))
  ...
  describe "#set_auto_renew" do
    it "enables auto-renewal" do
      stub_request(:get, "#{api_url}/setAutoRenew")
        .with(query: hash_including("username" => "test_user", "password" => "test_pass", "domain" => "example.com",
                                    "autoRenew" => "true"))
        .to_return(body: xml_response(200, "Success"))
